...
class HssOktaFlutterPluginApi {
  ...
  Future<OktaAuthenticationResult?> startBrowserAuthenticationFlow() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.hss_okta_flutter.HssOktaFlutterPluginApi.startBrowserAuthenticationFlow', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
  ...
  Future<bool> startWebSignoutFlow() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.hss_okta_flutter.HssOktaFlutterPluginApi.startWebSignoutFlow', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
