...
private fun wrapError(exception: Throwable): List<Any?> {
  return if (exception is HssOktaFlutterException) {
    listOf(
      exception.code,
      exception.message,
      exception.details
...
data class AuthenticationResult (
  ...
  companion object {
    ...
    fun fromList(__pigeon_list: List<Any?>): AuthenticationResult {
      val result = __pigeon_list[0] as DirectAuthenticationResult?
...
private object HssOktaFlutterPluginApiPigeonCodec : StandardMessageCodec() {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      ...
      is DirectAuthenticationResult -> {
        stream.write(135)
        writeValue(stream, value.raw)
      }
      is AuthenticationFactor -> {
        stream.write(136)
        writeValue(stream, value.raw)
      }
...
interface HssOktaFlutterPluginApi {
  ...
  companion object {
    ...
    val codec: MessageCodec<Any?> by lazy {
      HssOktaFlutterPluginApiPigeonCodec
    }
